...
public final class Constants {
  ...
  public static final class Auton2BallRightConstants {
    ...
    public static double kBackOut_Time          = config.getDouble("AUTON_2BALL_RIGHT_kBackOut_Time", 1);
  ...
  public static final class Auton3BallRightConstants {
    ...
    public static double kToShoot_Time          = config.getDouble("AUTON_3BALL_RIGHT_kToShoot_Time", 2.0);
  ...
  public static final class Auton4BallConstants {
    ...
    //public static double kFromTerm_Time         = config.getDouble("AUTON_4BALL_kFromTerm_Time", 2.0);
